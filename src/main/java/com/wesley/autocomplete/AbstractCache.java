...
public class AbstractCache {
	...
	protected boolean put(String cacheKey, Object cached) throws ACException{
    	if (!trimToCapcity()){
    		String errMessage = "Cache is full when puting the key: " + cacheKey + ".";
    		throw new ACException(errMessage);
    	}
	...
	protected boolean put(Long cacheKey, Object cached) throws ACException{
